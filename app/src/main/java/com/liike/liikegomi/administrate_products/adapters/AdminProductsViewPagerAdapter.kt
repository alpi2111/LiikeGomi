...
class AdminProductsViewPagerAdapter(private val productsList: List<Categoria>, fragment: FragmentManager, lifecycle: Lifecycle) : FragmentStateAdapter(fragment, lifecycle) {
    override fun getItemCount(): Int = productsList.size

    override fun createFragment(position: Int): Fragment {
        val idCategory = productsList[position].idCategory
        return AdminProductFragment(idCategory)
    }
}